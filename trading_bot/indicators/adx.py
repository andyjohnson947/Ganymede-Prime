...
def detect_market_regime(
    ...
    DUAL-MODE STRATEGY:
    - Ranging markets (ADX < threshold): Mean reversion
    - Trending markets (ADX >= threshold): Breakout/momentum
    ...
    if adx_value < adx_threshold:
        ...
        description = f"Ranging market - Mean reversion safe (ADX: {adx_value:.1f})"
    else:
        regime = 'trending'
        strategy = 'breakout'
        description = f"Trending market - Breakout mode (ADX: {adx_value:.1f})"
    ...
    return {
        ...
        'should_trade': True  # Always trade, just different strategies
    }
